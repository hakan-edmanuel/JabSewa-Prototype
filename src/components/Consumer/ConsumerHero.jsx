export default function ConsumerHero({ onSearch }) {
  ...
  return (
    <section className="consumer-hero" style={{
      padding: '80px 20px',
      background: '#ffffff',
      borderBottom: '1px solid #e5ebf4'
    }}>
      <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
        <h1 className="consumer-hero-title" style={{ fontSize: '3rem', fontWeight: '800', color: '#0f172a', marginBottom: '20px', lineHeight: '1.2', letterSpacing: '-0.03em' }}>
        ...
        <div className="consumer-search-container" style={{ display: 'flex', gap: '12px', background: 'white', padding: '10px', borderRadius: '20px', border: '1px solid #e2e8f0', maxWidth: '100%' }}>
          ...
          <input
            ...
            style={{ flex: 1, minWidth: 0, padding: '14px 16px', border: 'none', background: 'transparent', fontSize: '1.05rem', color: '#334155', outline: 'none' }}
          />
          <button className="consumer-search-btn" style={{ background: '#fbbf24', color: '#0f172a', border: 'none', padding: '0 40px', borderRadius: '14px', fontWeight: 'bold', fontSize: '1rem', cursor: 'pointer', transition: 'transform 0.2s', whiteSpace: 'nowrap', flexShrink: 0 }}>
            Cari
          </button>
        </div>
